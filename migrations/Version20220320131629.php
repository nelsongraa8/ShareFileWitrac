 ...
 */
final class Version20220320131629 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, files_block_id INTEGER DEFAULT NULL, email VARCHAR(180) NOT NULL, roles CLOB NOT NULL --(DC2Type:json)
        , password VARCHAR(255) NOT NULL, CONSTRAINT FK_8D93D6491C439B44 FOREIGN KEY (files_block_id) REFERENCES file (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
